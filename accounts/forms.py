...
class UserProfileForm(forms.ModelForm):
    ...
    date_joined = forms.DateField(
        required=False, label='Joined Date',
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance and self.instance.user:
            ...
            self.initial['date_joined'] = self.instance.user.date_joined.date()
        field_order = ['first_name', 'last_name', 'email', 'department', 'phone_number', 'job_title', 'date_joined', 'is_manager', 'password1', 'password2', 'profile_picture']
    ...
    def save(self, commit=True):
        ...
        if commit:
            ...
            if self.cleaned_data.get('date_joined'):
